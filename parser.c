...
ast_T** parser_parse_statements(parser_T* parser, int* ll_size) {
     ...
     *ll_size = 0;
     ...
     while (parser->current_token != NULL && parser->current_token->type != TOKEN_RCURLY) { 
          ...
          ast_T* statement = parser_parse_statement(parser, local_scope, global_scope);
...
ast_T* parser_parse_statement(parser_T* parser, scope_T* local_scope, scope_T* global_scope){
     switch (parser->current_token->type)
     {
          case TOKEN_MAIN: return parser_parse_main(parser, local_scope, global_scope);
          // Literals
          case TOKEN_ID: return parser_parse_id(parser, local_scope, global_scope); break;
          case TOKEN_INT_TYPE:
          case TOKEN_DOUBLE_TYPE:
          case TOKEN_BOOLEAN_TYPE:
          case TOKEN_STRING_TYPE:
          case TOKEN_CHAR_TYPE:
               return parser_parse_variable_definition(parser, parser->current_token->type, local_scope, global_scope);
          case TOKEN_PROCESS: return parser_parse_process_definition(parser, local_scope, global_scope);
          case TOKEN_FUNC: return parser_parse_func_definition(parser, local_scope, global_scope);
          case TOKEN_HELPER: return parser_parse_helper_definition(parser, local_scope, global_scope);
          case TOKEN_EMIT: return parser_parse_emit(parser, local_scope, global_scope);
          case TOKEN_IS: return parser_parse_conditional(parser, local_scope, global_scope);
          case TOKEN_EXPRESSION_INT:
          case TOKEN_EXPRESSION_DOUBLE: 
          case TOKEN_EXPRESSION_IDENTIFIER:
          case TOKEN_EXPRESSION_BOOLEAN:
               return parser_parse_expression(parser, local_scope, global_scope);
          case TOKEN_INT:
               return parser_parse_int(parser, local_scope, global_scope);
          case TOKEN_STRING: 
               return parser_parse_string(parser, local_scope, global_scope);
          case TOKEN_DOUBLE:
               return parser_parse_double(parser, local_scope, global_scope);
          case TOKEN_CHARACTER:
               return parser_parse_character(parser, local_scope, global_scope);
          case TOKEN_BOOLEAN:
               return parser_parse_boolean(parser, local_scope, global_scope);
     }
...
// --------------------------------------------------------------------------
ast_T* parser_parse_variable_definition(parser_T* parser, int type, scope_T* local_scope, scope_T* global_scope) {
     ...
     node->token.ast_variable_definition.value = parser_parse_statement(parser, local_scope, global_scope);
...
//                          LITERAL DEFINITIONS
// --------------------------------------------------------------------------
ast_T* parser_parse_int(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
...
ast_T* parser_parse_double(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
...
ast_T* parser_parse_string(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
...
ast_T* parser_parse_character(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
...
ast_T* parser_parse_boolean(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
...
ast_T* parser_parse_id(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
     ast_T* node = NULL;
     ...
     if (parser->current_token->type == TOKEN_LPAREN) {
          ast_T* args = parser_parse_arguments_called(parser, local_scope, global_scope);
...
// --------------------------------------------------------------------------
ast_T* parser_parse_process_definition(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
     ...
     // args 
     process_node->token.ast_process_definition.args = parser_parse_arguments_declared(parser, local_scope, global_scope);
     // body
     ...
     process_node->token.ast_process_definition.func = parser_parse_func_definition(parser, local_scope, global_scope);
     ...
     while (parser->current_token->type != TOKEN_RCURLY) {
          ...
          process_node->token.ast_process_definition.helpers[num] = parser_parse_helper_definition(parser, local_scope, global_scope); // if there's no helpers this will break
          num += 1;
     ...
     process_node->local_scope = local_scope;
     process_node->global_scope = global_scope;

     return process_node;
}

ast_T* parser_parse_func_definition(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
...
ast_T* parser_parse_helper_definition(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
     ...
     // args 
     helper_node->token.ast_process_definition.args = parser_parse_arguments_declared(parser, local_scope, global_scope);
...
ast_T* parser_parse_arguments_declared(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
...
ast_T* parser_parse_arguments_called(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
     ast_T* node = init_ast(AST_ARG_LIST);
     ...
     while (parser->current_token->type != TOKEN_RPAREN) {
          ...
          if (parser->lexer->current_char ==  ':') { // if named arg
               ...
               arg->token.ast_named_arg.expression = parser_parse_statement(parser, local_scope, global_scope);
               arg->local_scope = local_scope;
               arg->global_scope = global_scope;
          }
          else { // if unnamed arg
               arg = init_ast(AST_UNNAMED_ARG);
               arg->token.ast_unnamed_arg.expression = parser_parse_statement(parser, local_scope, global_scope);
               arg->local_scope = local_scope;
               arg->global_scope = global_scope;
          }
          node->token.ast_arg_list.args[num] = arg;
...
ast_T* parser_parse_main(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
...
//  <Unary> ::= "!" <Expr> | <Literal>
// --------------------------------------------------------------------------
ast_T* parser_parse_expression(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
     ast_T* node = init_ast(AST_EXPRESSION);

     node->token.ast_expression.left = parser_parse_equality(parser, local_scope, global_scope);
     ...
     while (parser->current_token->type == TOKEN_AND || parser->current_token->type == TOKEN_OR) {
          ...
          parser_move_forward(parser, parser->current_token->type);
          node->token.ast_expression.right = parser_parse_equality(parser, local_scope, global_scope);
     }
...
ast_T* parser_parse_equality(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
     ast_T* node = init_ast(AST_EQUALITY);

     node->token.ast_equality.left = parser_parse_comparison(parser, local_scope, global_scope);
     ...
     while (parser->current_token->type == TOKEN_BANG_EQUAL || parser->current_token->type == TOKEN_EQUAL_EQUAL) {
          ...
          parser_move_forward(parser, parser->current_token->type);
          node->token.ast_equality.right = parser_parse_comparison(parser, local_scope, global_scope);
     }
...
ast_T* parser_parse_comparison(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
     ast_T* node = init_ast(AST_COMPARISON);

     node->token.ast_comparison.left = parser_parse_term(parser, local_scope, global_scope);
     ...
     while (parser->current_token->type == TOKEN_GREATER ||
          ...
          parser_move_forward(parser, parser->current_token->type);
          node->token.ast_comparison.right = parser_parse_term(parser, local_scope, global_scope);
     }
...
ast_T* parser_parse_term(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
     ast_T* node = init_ast(AST_TERM);

     node->token.ast_term.left = parser_parse_factor(parser, local_scope, global_scope);

     while (parser->current_token->type == TOKEN_PLUS || parser->current_token->type == TOKEN_MINUS) {
          node->token.ast_term.operator = parser->current_token->value;
          parser_move_forward(parser, parser->current_token->type);
          node->token.ast_term.right = parser_parse_factor(parser, local_scope, global_scope);
     }
...
ast_T* parser_parse_factor(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
     ast_T* node = init_ast(AST_FACTOR);

     node->token.ast_term.left = parser_parse_unary(parser, local_scope, global_scope);

     while (parser->current_token->type == TOKEN_DIVIDE || parser->current_token->type == TOKEN_STAR) {
          node->token.ast_term.operator = parser->current_token->value;
          parser_move_forward(parser, parser->current_token->type);
          node->token.ast_term.right = parser_parse_unary(parser, local_scope, global_scope);
     }
...
ast_T* parser_parse_unary(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
     ...
     node->token.ast_unary.stmt = parser_parse_statement(parser, local_scope, global_scope);
...
ast_T* parser_parse_conditional(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
     ast_T* node = init_ast(AST_CONDITIONAL);
     parser_move_forward(parser, TOKEN_IS);
     parser_move_forward(parser, TOKEN_LPAREN);


     node->token.ast_conditional.condition = parser_parse_statement(parser, local_scope, global_scope);
...
ast_T* parser_parse_emit(parser_T* parser, scope_T* local_scope, scope_T* global_scope) {
     ast_T* node = init_ast(AST_EMIT);
     parser_move_forward(parser, TOKEN_EMIT);
     node->token.ast_emit.stmt = parser_parse_statement(parser, local_scope, global_scope);
     if (parser->current_token->type == TOKEN_SEMICOLON) {
          parser_move_forward(parser, TOKEN_SEMICOLON);
     }
