...
ast_T* parser_parse_statement(parser_T* parser, scope_T* scope){
     ...
     {
          case TOKEN_MAIN: return parser_parse_main(parser, scope);
          // Literals
          ...
          case TOKEN_CHAR_TYPE:
               return parser_parse_variable_definition(parser, parser->current_token->type, scope);
          case TOKEN_PROCESS: return parser_parse_process_definition(parser, scope);
          case TOKEN_FUNC: return parser_parse_func_definition(parser, scope);
          case TOKEN_HELPER: return parser_parse_helper_definition(parser, scope);
          case TOKEN_EMIT: return parser_parse_emit(parser, scope);
          case TOKEN_IS: return parser_parse_conditional(parser, scope);
          case TOKEN_EXPRESSION_INT:
          case TOKEN_EXPRESSION_DOUBLE: 
          case TOKEN_EXPRESSION_IDENTIFIER:
          case TOKEN_EXPRESSION_BOOLEAN:
               return parser_parse_expression(parser, scope);
          case TOKEN_INT:
               return parser_parse_int(parser, scope);
          case TOKEN_STRING: 
               return parser_parse_string(parser, scope);
          case TOKEN_DOUBLE:
               return parser_parse_double(parser, scope);
...
// --------------------------------------------------------------------------
ast_T* parser_parse_variable_definition(parser_T* parser, int type, scope_T* scope) {
     ...
     node->token.ast_variable_definition.value = parser_parse_statement(parser, scope);
...
ast_T* parser_parse_double(parser_T* parser, scope_T* scope) {
...
ast_T* parser_parse_id(parser_T* parser, scope_T* scope) {
     ...
     if (parser->current_token->type == TOKEN_LPAREN) {
          ast_T* args = parser_parse_arguments_called(parser, scope);
...
// --------------------------------------------------------------------------
ast_T* parser_parse_process_definition(parser_T* parser, scope_T* scope) {
     ...
     // args 
     process_node->token.ast_process_definition.args = parser_parse_arguments_declared(parser, scope);
     // body
     ...
     process_node->token.ast_process_definition.func = parser_parse_func_definition(parser, scope);
     ...
     while (parser->current_token->type != TOKEN_RCURLY) {
          ...
          process_node->token.ast_process_definition.helpers[num] = parser_parse_helper_definition(parser, scope); // if there's no helpers this will break
          num += 1;
...
ast_T* parser_parse_helper_definition(parser_T* parser, scope_T* scope) {
     ...
     // args 
     helper_node->token.ast_process_definition.args = parser_parse_arguments_declared(parser, scope);
...
ast_T* parser_parse_arguments_declared(parser_T* parser, scope_T* scope) {
...
ast_T* parser_parse_arguments_called(parser_T* parser, scope_T* scope) {
     ast_T* node = init_ast(AST_ARG_LIST);
...
ast_T* parser_parse_main(parser_T* parser, scope_T* scope) {
...
ast_T* parser_parse_expression(parser_T* parser, scope_T* scope) {
     ...
     node->token.ast_expression.left = parser_parse_equality(parser, scope);
     ...
     while (parser->current_token->type == TOKEN_AND || parser->current_token->type == TOKEN_OR) {
          ...
          parser_move_forward(parser, parser->current_token->type);
          node->token.ast_expression.right = parser_parse_equality(parser, scope);
     }
...
ast_T* parser_parse_equality(parser_T* parser, scope_T* scope) {
     ...
     node->token.ast_equality.left = parser_parse_comparison(parser, scope);
...
ast_T* parser_parse_comparison(parser_T* parser, scope_T* scope) {
     ...
     node->token.ast_comparison.left = parser_parse_term(parser, scope);
...
ast_T* parser_parse_term(parser_T* parser, scope_T* scope) {
     ...
     node->token.ast_term.left = parser_parse_factor(parser, scope);
...
ast_T* parser_parse_factor(parser_T* parser, scope_T* scope) {
     ...
     node->token.ast_term.left = parser_parse_unary(parser, scope);
...
ast_T* parser_parse_unary(parser_T* parser, scope_T* scope) {
...
ast_T* parser_parse_conditional(parser_T* parser, scope_T* scope) {
     ast_T* node = init_ast(AST_CONDITIONAL);
     parser_move_forward(parser, TOKEN_IS);
     parser_move_forward(parser, TOKEN_LPAREN);


     node->token.ast_conditional.condition = parser_parse_statement(parser, scope);
...
ast_T* parser_parse_emit(parser_T* parser, scope_T* scope) {
     ast_T* node = init_ast(AST_EMIT);
     parser_move_forward(parser, TOKEN_EMIT);
     node->token.ast_emit.stmt = parser_parse_statement(parser, scope);
     if (parser->current_token->type == TOKEN_SEMICOLON) {
          parser_move_forward(parser, TOKEN_SEMICOLON);
     }
     return node;
